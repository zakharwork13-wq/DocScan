/* @ts-self-types="./docscan_scanner.d.ts" */
...
export function scanText(text) {
    try {
        ...
        wasm.scanText(retptr, ptr0, len0);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('docscan_scanner_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
