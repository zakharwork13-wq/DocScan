 ...
 */
export function scanText(text: string): any;

/**
 * Тип находок, которые умеет определять движок.
 */
export function supportedTypes(): any[];
...
export interface InitOutput {
    ...
    readonly main: () => void;
    readonly scanText: (a: number, b: number, c: number) => void;
    readonly supportedTypes: (a: number) => void;
